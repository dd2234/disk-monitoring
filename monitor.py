    ...
    for ec2_instance_id in ec2_instance_ids:
        ...
        for volume in response['Volumes']:
            ...
            if metrics['Datapoints']:
                ...
                print(f"No data for instance {ec2_instance_id} volume {volume_id} in the last 5 minutes.")
        ...
        if cpu_metrics['Datapoints']:
            ...
            print(f"No data for instance {ec2_instance_id} CPU usage in the last 5 minutes.")
        ...
        if memory_metrics['Datapoints']:
            ...
            print(f"No data for instance {ec2_instance_id} memory usage in the last 5 minutes.")
